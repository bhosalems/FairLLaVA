...
def _ensure_master_env():
    # Don’t override if torchrun/SLURM already set these
...
class GREEN:
    ...
    def compute_summary(self):
        ...
        # representative_sentences = self.get_representative_sentences(self.completions) # We do not need this info for now, skipping to save time. # TODO if needed uncomment
