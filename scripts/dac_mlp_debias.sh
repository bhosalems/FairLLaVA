...
model_name_or_path="/home/csgrad/mbhosale/phd/MrFair/LLaVA-Rad/checkpoints/biomedclip_cxr_518-lora-3e-1e-4-20251016135336" #lmsys/vicuna-7b-v1.5 ===> For fairness finetuning we do not have to start at Vicuna weights. We can rather use llava-rad directly.
...
WANDB_PROJECT="llava" WANDB_RUN_ID="llava-ft-$(date +%Y%m%d%H%M%S)" WANDB_RUN_GROUP=fine-tune \
    ...
    --fairness_config /home/csgrad/mbhosale/phd/MrFair/LLaVA-Rad/configs/fairness_finetune_dac_mlp.json \
    --seed 42