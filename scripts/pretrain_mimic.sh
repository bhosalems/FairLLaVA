#!/bin/bash
# Script to pretrain the mmmlp adapter for further finetuning stage.
# Uncomment and set the following variables correspondingly to run this script:

model_base=lmsys/vicuna-7b-v1.5
output_dir="${1:-./checkpoints}"

data_path=/a2il/data/mbhosale/MrFair/physionet.org/mimc-cxr-jpeg/gpt4-reports/chat_train_MIMIC_CXR_all_gpt4extract_rulebased_v1.json
loader="mimic_train_findings"
image_folder=/a2il/data/mbhosale/MrFair/physionet.org/mimc-cxr-jpeg/files
