...
# Call this script for ablation either with or without MI loss and with and without pretrained DAC classifier respectively.
# Also check the line 1292 in train.py htat load the pretrained CLUB classifier.
################## VICUNA ##################
PROMPT_VERSION=v1
...
WANDB_PROJECT="llava" WANDB_RUN_ID="llava-ft-$(date +%Y%m%d%H%M%S)" WANDB_RUN_GROUP=fine-tune \
    ...
    --fairness_config /home/csgrad/mbhosale/phd/MrFair/LLaVA-Rad/configs/dac_mi_finetune_mimic_cxr.json \
    --seed 42