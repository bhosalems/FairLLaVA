...
PROJECTOR="/home/csgrad/mbhosale/phd/MrFair/LLaVA-Rad/checkpoints/biomedclip_cxr_518-pt-1e-1e-3-20251031194906/mm_projector.bin" #"/home/csgrad/mbhosale/phd/MrFair/LLaVA-Rad/checkpoints/llavarad-merged/mm_projector.bin" # generated using pretrain.sh
...
################## Data ##################
data_path=/a2il/data/mbhosale/MrFair/Padchest/train_findings.json
loader="padchest_train_findings"
image_folder=/data_local1/mbhosale/MrFair/Padchest/images
################## Data ##################
...
WANDB_PROJECT="llava" WANDB_RUN_ID="llava-ft-$(date +%Y%m%d%H%M%S)" WANDB_RUN_GROUP=fine-tune \
    ...
    --fairness_config /home/csgrad/mbhosale/phd/MrFair/LLaVA-Rad/configs/fairness_finetune_padchest.json \

# LLAVARAD PEF-training
################## VICUNA ##################
# PROMPT_VERSION=v1
